...
public class LroadScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int a = 0; a <= rndHowManyCars; a++)
        {
            ...
            GameObject Car = Instantiate(Cars[rndCar], new Vector3(LastCarPosition + Distance, 2, gameObject.transform.position.z), Quaternion.Euler(0, 0, 0), gameObject.transform);
