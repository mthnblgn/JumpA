...
public class RroadScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int a = 0; a <= rndHowManyCars; a++)
        {
            ...
            GameObject Car = Instantiate(CarTypes[rndCar], new Vector3(LastCarPosition - Distance, 2, gameObject.transform.position.z), Quaternion.Euler(0, 180, 0), gameObject.transform);
