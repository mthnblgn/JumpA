...
public class RroadScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //    GameObject Car = Instantiate(CarTypes[rndCar], new Vector3(LastCarPosition / CarScale - Distance, 2, gameObject.transform.position.z), Quaternion.Euler(0, 180, 0), gameObject.transform);
    ...
    void Update()
    {
        ...
        if (sayac >= rndSure)
        {
            GameObject Car = Instantiate(CarTypes[rndCar], new Vector3(LastCarPosition, 2, gameObject.transform.position.z), Quaternion.Euler(0, 180, 0), gameObject.transform);
            sayac = 0;
            Cars.Add(Car);
